...
//    GamePlayer player2 = new AIPlayerDynamic(2,6);
    ...
    public GamePanel(int op1,int op2){
        if(op1 ==1){
            ...
            this.player2 = new HumanPlayer(2);
                ...
                this.player1 = new HumanPlayer(1);
                if(op2 ==1){
//                    ! this should be easy difficulty             replace with dfs
                    this.player2 = new AiEasyPlayer(2,1,false);
                }else if(op2 ==2) {
//                    ! this should be hard difficulty
                    this.player2 = new AIPlayerDynamic(2, 6);
                }
        }
        else if(op1 ==3){
                this.player1 = new AIPlayerRealtimeKiller(1,6,true);
                this.player2 = new AIPlayerDynamic(2,6);
        }
